...
// PNG decode lives in its own subpath (`termcade/png`) because it is the only
...
// no native deps. Handles all five color types plus tRNS transparency. Throws on
// the formats not needed yet (16-bit, Adam7 interlace) rather than guessing.
